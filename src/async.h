...
/** @brief Wrapper structure for representing reads of processed files
    ...
    with reads from this \a blockinfo_t structure.
*/
struct blockinfo_t
 {
   struct block_t * fwd;    /**< @brief Pointer to the forwards reads block */
   struct block_t * rev;    /**< @brief Pointer to the reverse reads block */
...
/** @brief A global data structure used to control program flow
    ...
    read two blockinfo structures but the threads operate only on one of them, i.e. they
...
struct thread_global_t
 {
   struct blockinfo_t * xblock; /**< @brief Pointer to the first \a blockinfo_t buffer (main processing buffer) */
   struct blockinfo_t * yblock; /**< @brief Pointer to the second \a blockinfo_t buffer (double-buffer) */
